...
import primerclase.modelo.Manager;
...
public class GestorEmpleados {
	...
	public static void generarEmpleados(Employee empleado) {
		empleado.setReportees(GestorEmpleados.generateRandomEmployees(Utilidades.generarRandomInt(10,100), empleado.getUbicacion(), empleado.getLegajo(), empleado));
